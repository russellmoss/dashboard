...
export function exportWeeklyGoalsCSV(
  ...
  const columns = [
    ...
    { key: 'mqlGoal', header: 'MQL Goal' },
    { key: 'mqlActual', header: 'MQL Actual' },
    { key: 'mqlDiff', header: 'MQL Difference' },
    { key: 'sqlGoal', header: 'SQL Goal' },
    { key: 'sqlActual', header: 'SQL Actual' },
    { key: 'sqlDiff', header: 'SQL Difference' },
    ...
    { key: 'leadsSourcedGoal', header: 'Leads Sourced Goal' },
    { key: 'leadsSourcedActual', header: 'Leads Sourced Actual' },
    { key: 'leadsSourcedDiff', header: 'Leads Sourced Difference' },
    { key: 'leadsContactedGoal', header: 'Leads Contacted Goal' },
    { key: 'leadsContactedActual', header: 'Leads Contacted Actual' },
    { key: 'leadsContactedDiff', header: 'Leads Contacted Difference' },
  ...
  const csvData = goals.map(goal => ({
    ...
    mqlActual: goal.mqlActual,
    mqlDiff: goal.mqlDiff ?? '',
    sqlGoal: goal.sqlGoal ?? '',
    sqlActual: goal.sqlActual,
    sqlDiff: goal.sqlDiff ?? '',
    ...
    leadsSourcedActual: goal.leadsSourcedActual,
    leadsSourcedDiff: goal.leadsSourcedDiff ?? '',
    leadsContactedGoal: goal.leadsContactedGoal ?? '',
    leadsContactedActual: goal.leadsContactedActual,
    leadsContactedDiff: goal.leadsContactedDiff ?? '',
...
export function exportClosedLostCSV(
  ...
  const columns = [
    ...
    { key: 'daysSinceClosedLost', header: 'Days Since Closed Lost' },
    ...
    { key: 'timeSinceClosedLostBucket', header: 'Closed Lost Time Bucket' },
...
export function exportAdminOverviewCSV(
  ...
  const columns = [
    ...
    { key: 'weeklyGoalMQL', header: 'Week Goal - MQL' },
    { key: 'weeklyGoalSQL', header: 'Week Goal - SQL' },
    ...
    { key: 'weeklyGoalLeadsSourced', header: 'Week Goal - Leads Sourced' },
    { key: 'weeklyGoalLeadsContacted', header: 'Week Goal - Leads Contacted' },
    { key: 'weeklyActualMQL', header: 'Week Actual - MQL' },
    { key: 'weeklyActualSQL', header: 'Week Actual - SQL' },
    ...
    { key: 'weeklyActualLeadsSourced', header: 'Week Actual - Leads Sourced' },
    { key: 'weeklyActualLeadsContacted', header: 'Week Actual - Leads Contacted' },
  ...
  const csvData = overviews.map(overview => ({
    ...
    weeklyGoalMQL: overview.currentWeekGoal?.mqlGoal ?? '',
    weeklyGoalSQL: overview.currentWeekGoal?.sqlGoal ?? '',
    ...
    weeklyGoalLeadsSourced: overview.currentWeekGoal?.leadsSourcedGoal ?? '',
    weeklyGoalLeadsContacted: overview.currentWeekGoal?.leadsContactedGoal ?? '',
    weeklyActualMQL: overview.currentWeekActual?.mqls ?? '',
    weeklyActualSQL: overview.currentWeekActual?.sqls ?? '',
    ...
    weeklyActualLeadsSourced: overview.currentWeekActual?.leadsSourced ?? '',
    weeklyActualLeadsContacted: overview.currentWeekActual?.leadsContacted ?? '',
