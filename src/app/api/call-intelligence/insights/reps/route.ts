...
import { getVisibleRepsDetail } from '@/lib/queries/call-intelligence/visible-reps-detail';
...
export async function GET() {
  try {
    ...
    const reps = await getVisibleRepsDetail(visibleRepIds);
    return NextResponse.json({ reps });
  } catch (err) {
    console.error('[/api/call-intelligence/insights/reps] error', err);
