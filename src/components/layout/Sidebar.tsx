...
import {
  ...
  Bot, Layers, Briefcase, MessageSquarePlus, MapPin, Banknote, Trophy, TrendingUp, PhoneCall
} from 'lucide-react';
...
const PAGES = [
  ...
  { id: 16, name: 'GC Hub', href: '/dashboard/gc-hub', icon: Banknote },
  { id: 19, name: 'Pipeline Forecast', href: '/dashboard/forecast', icon: TrendingUp },
