...
|-----------|------|-------------|
| `AdvisorMapClient` | `src/components/advisor-map/AdvisorMapClient.tsx` | Client-side Leaflet map with marker clustering, advisor popups, and filter controls |
| `AdvisorMap` | `src/components/advisor-map/AdvisorMap.tsx` | Wrapper handling data fetching and passing props to AdvisorMapClient |
