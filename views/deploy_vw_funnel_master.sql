...
With_Channel_Mapping AS (
  SELECT
    c.*,
    -- Raw Finance_View__c preserved for debugging/traceability
    IFNULL(c.Finance_View__c, 'Other') AS Channel_Grouping_Name_Raw,
    -- Post-hoc reporting channel overrides.
    -- Source of truth remains Finance_View__c on Lead/Opportunity records.
    -- These overrides consolidate channels for dashboard reporting only.
    -- To add/remove/change consolidations, edit this CASE statement.
