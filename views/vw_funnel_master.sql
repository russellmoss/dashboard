-- vw_funnel_master — modified 2026-03-22
-- Added: Actual_ARR__c, SGM_Estimated_ARR__c, Stage_Entered_Joined__c, Account_Total_ARR__c
-- For SGM Hub Dashboard tab
...
Opp_Base AS (
  SELECT
    o.Id AS Full_Opportunity_ID__c,
    o.Name AS Opp_Name,
    o.OwnerId AS Opp_OwnerId,
    o.Final_Source__c AS Opp_Original_Source,
    o.Finance_View__c AS Opp_Finance_View__c,
    o.SGA__c AS Opp_SGA_Name,
    o.Opportunity_Owner_Name__c AS Opp_SGM_Name,
    o.SQL__c AS SQO_raw,
    ...
    o.External_Agency__c AS Opp_External_Agency__c,
    o.CampaignId AS Opp_Campaign_Id__c,
    o.NextStep AS Opp_NextStep,
    o.Actual_ARR__c,
    o.SGM_Estimated_ARR__c,
