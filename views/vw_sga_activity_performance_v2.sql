...
SELECT
  ...
  CASE
    ...
    WHEN Subject LIKE '%[lemlist]%' THEN 'Email (Campaign)'
    WHEN Type = 'Email'
  ...
  CASE
    ...
    WHEN Subject LIKE '%[lemlist]%' OR Subject LIKE 'Sent Savvy raised%' OR Type = 'Email' OR TaskSubtype = 'Email' OR Subject LIKE 'Email:%' OR Subject LIKE 'Sent %' THEN 'Email'
