...
| Files matching `^src/components/.+\.tsx?$` | Components section in `docs/ARCHITECTURE.md` | — |
| Files matching `^src/lib/.+\.ts$` | Libraries section in `docs/ARCHITECTURE.md` | — |
| Files matching `^src/hooks/.+\.ts$` | Hooks section in `docs/ARCHITECTURE.md` | — |
| Files matching `^src/types/.+\.ts$` | Types section in `docs/ARCHITECTURE.md` | — |
| Files matching `^src/config/.+\.ts$` | Configuration section in `docs/ARCHITECTURE.md` | — |
